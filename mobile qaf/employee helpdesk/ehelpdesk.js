...
function getPendingServices() {
    serviceList=[]
    fetch(`${apURL}/api/MyServices?option=PS&app=helpdesk&templateType=ehelpdesk`, {
        method: 'POST',
        headers: {
    ...
    <div class="third-div">
        <p class="normal">${getRequestStatus(val)}</p>
                ...
                document.getElementById('requests').innerHTML = '<div class="noRecordFound">No Record Found</div>'
            }
        })
}
