...
var expenseGrid = {
    ...
    columns: [
        { field: 'Customer', displayName: 'Customer', sorting: false },
        { field: 'Employee', displayName: 'Employee', sorting: false },
        { field: 'StartDate', displayName: 'Start Date', sorting: false },
        { field: 'EndDate', displayName: 'End Date', sorting: false },
        ...
        { field: 'HourlyRate', displayName: 'Hourly Rate', sorting: false },

    ],
    viewFields: ["Customer", "Employee", "StartDate", "EndDate", "NumberofHours", "BillingAmount", "HourlyRate"],
    page: 1,
    pageSize: 10,
...
function expgrid_onItemRender(cname, cvalue, row) {
    ...
    if(cname === 'StartDate'||cname === 'EndDate'){
        if(cvalue ){
