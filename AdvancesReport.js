...
viewFields: ['SelectEmployee','RequestFor','CurrentLedgerBalance','RequestTitle','Department','TotalAmount','Description'],
    page: 1,
    pageSize: 10,
...
let gridExpenseColumnsReport = [
  {field:'SelectEmployee', displayName:'Request For',sequence:1, sorting: true},
    ...
    {field:'TotalAmount', displayName:'Total Amount',sequence:6, sorting: true},
      ...
      window.QafService.GetItems(expenseGridReport.repository, expenseGridReport.viewFields, expenseGridReport.pageSize, expenseGridReport.page, filterGridCondition,'',orderBy).then((filteredExpense)=>{
        if(filteredExpense&&filteredExpense.length>0){
          filteredExpense.forEach(val=>{
            ...
            val.CurrentLedgerBalance=val.CurrentLedgerBalance||val.CurrentLedgerBalance===0?val.CurrentLedgerBalance:''
            val.ApprovedLoanAmount=val.ApprovedLoanAmount?val.ApprovedLoanAmount:''
