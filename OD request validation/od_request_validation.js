...
function externalFormValidationRule() {
    ...
    return new Promise(async (resolve) => {
         selectedDate = document.getElementById('StartDate')
...
function addCustomjs() {
    ...
    // let jsList=["https://funfirst.quickappflow.com/Attachment/downloadfile?fileUrl=JS_Library%2Fmoment.min_44ef7032-a417-43ef-b473-87c4067fc427.js","https://funfirst.quickappflow.com/Attachment/downloadfile?fileUrl=JS_Library%2Flibraray_50bbeca6-b1e5-4c54-8f11-dfa817ab0616.js"]
    jsList.forEach(val => {
        loadScript(val)
    })
}
