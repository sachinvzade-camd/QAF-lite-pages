    ...
    if (Array.isArray(settings) && settings.length > 0) {
      ...
      const showInHtml = updatedJob.forEach((candidate, index) => {
        ...
        <div class="main">
            ...
            <div class="row2">
              <div class="column">
                ...
                <div class="experiance">
                  <p>â‚¹&nbsp;${candidate.ExpectedSalary == null ? "" : candidate.ExpectedSalary}&nbsp;|&nbsp;${candidate.TotalExperience == null ? "" : candidate.TotalExperience}Y&nbsp;|&nbsp; ${candidate.NoticePeriod == null ? "" : candidate.NoticePeriod} d &nbsp;|&nbsp; ${candidate.CurrentLocation == null ? "" : candidate.CurrentLocation}</p>
                </div>
              </div>
              <div class="contact">
              <div class="number">
          ...
          <div class="job">
          <p><em>Current Salary:</em>&nbsp; <span>â‚¹&nbsp;${candidate.CurrentSalary == null ? "" : candidate.CurrentSalary}</span></p>
