        ...
        if (window.QafService) {
            ...
            if (list.Entity.toLowerCase() === "Lead".toLowerCase()) {
                ...
                contacts.forEach(val=>{
                   val['FirstName']=val.Name?val.Name.split(" ")[0]:""
                   val['LastName']=val.Name?val.Name.split(" ")[1]:""
                   val['Mobile']=val.MobileNumber?val.MobileNumber:""
                })
            ...
            this.innerHTML = `
                <style>
                   ...
                   <div class="right-container">
                        <div class="addform">
                            <button class="btn btn-primary" onclick="refresh()" style="float: right;"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                        </div>
                     </div>
