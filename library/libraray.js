...
font-weight: 500;
    ...
    `:this.innerHTML=""):"qaf-event"===t&&(eventNameqaf=e)}}function oncloseModal(t){let a=document.querySelector("qaf-alert");qafAlertObject.IsShow&&(qafAlertObject.IsShow=!1),a.setAttribute("qaf-alert-show",JSON.stringify(qafAlertObject));var e=new CustomEvent(eventNameqaf,{detail:t});window.parent.document.dispatchEvent(e)}customElements.get("qaf-alert")||customElements.define("qaf-alert",QafAlert);
