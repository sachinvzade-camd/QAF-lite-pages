 ...
 qafServiceLoaded = setInterval(() => {
    if (window.QafService) {
        ...
        setTimeout(() => {
            ...
            getAllData()
            whereClausecreate = `VisitDate>='${year + '/' + month + '/' + day}'<AND>VisitDate<='${year + '/' + month + '/' + day}'`;
    ...
    const html = `
        <div class="popup-content">
            ...
            <div class="qaf-form-group">
                ...
                <select class="fs-input" id="Category" name="category"></select>
            </div>
            <div class="qaf-form-group">
                <label for="problemType" class="fs-label">Type of Problem</label>
                <select class="fs-input" id="ProblemType" name="problemType"></select>
            </div>
            <div class="qaf-form-group">
