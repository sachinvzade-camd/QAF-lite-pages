...
let expenseGrid = {
    ...
    columns: [
          ...
          {field:'CompanyName', displayName:'Company Name', sorting: true},
          {field:'MobileNumber', displayName:'Mobile Number', sorting: true},
          {field:'Address', displayName:'Address', sorting: true},
    ],
    viewFields: ['FirstName',"LastName","Email","CompanyName","MobileNumber","Address"],
    page: 1,
    pageSize: 10,
...
let gridExpenseColumns = [
    ...
    {field:'CompanyName', displayName:'Company Name',sequence:4, sorting: true},
    {field:'MobileNumber', displayName:'Mobile Number',sequence:5, sorting: true},
    {field:'Address', displayName:'Address',sequence:6, sorting: true},
];
...
function expgrid_onItemRender(cname, cvalue, row){
    if(cname === 'FirstName'||cname === 'LastName'){
      if(cvalue ){
        return  `<a href=pages/vendordetails?vid=${row.RecordID} target="_blank">${cvalue}</a> `
      }
    }
    if(cvalue){
      return cvalue;
